...
export const Experiences: Experience[] = [
	{
		...
		description:
			"Worked on an internal platform providing DO-178 requirement and testing specification workflows for control system engineers",
...
export const Extracurriculars: Experience[] = [
	{
		...
		start_date: new Date(2026, 1),
		end_date: "Present",
		description: "Building backend systems for Canada's largest hackathon",
		technologies: [
			SKILL_TYPESCRIPT,
			SKILL_GRAPHQL,
			SKILL_PRISMA,
...
export const Projects: Project[] = [
	{
		...
		name: "flashbang",
		description:
			"Don't be the face of procrastination. Developed at UofTHacks 13 with Oliver Huang, Marcus Chuong, and Colin Wang.",
		links: [
			{
				name: "Devpost",
	...
	},
	{
		...
		name: "Gym Scroller",
		description:
			"When you don't have a gym buddy shouting at you for \"just one more\" rep, there really isn't a reason to finish that last rep. So why not solve this issue by scrolling reels? Developed at Hack the Valley X with Achita Anantachina, Emilee Chen, and Raymond Chen.",
		links: [
			{
				name: "Devpost",
